...
function VaporjawnHeader() {
    return (
        ...
        <p className='VaporjawnBlerb'>Vaporjawn is a multi-medium collective inspired by the spectrum of art that exists in the vaporwave community. <a className='VaporjawnLink' href="https://instagram.com/vaporjawn" target="_blank">Vaporjawn </a> 
