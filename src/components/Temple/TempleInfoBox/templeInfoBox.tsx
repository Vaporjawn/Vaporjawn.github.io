      ...
      <div className="templeWrapper-style2-container-special-alt">
        <div className="templeRow-half">
          <div className="templeInnerInfoBox">
            <header>
              <h2 className="templeInfoBoxTitle">Events at the University</h2>
            </header>
            <p className="templeInfoBoxText">
              One of my other favorite parts about the university is that the
            ...
            <footer>
              <ul className="templeInfoBoxButtons">
                <li className="templeInfoBoxPaddingLeft">
                  <a
