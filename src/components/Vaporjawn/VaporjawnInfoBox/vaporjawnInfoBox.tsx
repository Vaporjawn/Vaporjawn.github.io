      ...
      <div className="VaporjawnWrapper-style2-container-special-alt">
        <div className="VaporjawnRow-half">
          <div className="VaporjawnInnerInfoBox">
            <header>
              <h2 className="VaporjawnInfoBoxTitle">Vaporwave and Beyond</h2>
            </header>
            <p className="VaporjawnInfoBoxText">
              While my instagram account may be mostly inactive at the moment,
              there are still plenty of ways I contribute to the vaporwave
              community in my day to day life. One of the other artistic mediums
              that has a strong vaporwave fanbase is the musical side to the
              genre. Below is a link to some of my vaporwave music.
            </p>
            <footer>
              <ul className="VaporjawnInfoBoxButtons">
                <li className="VaporjawnInfoBoxPaddingLeft">
                  <a
