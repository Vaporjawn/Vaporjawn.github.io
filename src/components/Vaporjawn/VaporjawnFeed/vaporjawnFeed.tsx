...

  {
    ...
    return (
      <div className="VaporjawnPictureContainer">
        <div className="VaporjawnContainerHeader">
          <h2>
            ART FROM <strong>VAPORJAWN</strong>
          </h2>
        </div>
        ...
        <Link
          ...
          className="VaporjawnFeedAboutLink"
        >
          <div className="VaporjawnFeedAboutButton">About Vaporjawn</div>
        </Link>
      </div>
    );
  }
