    ...
    <div>
      <div className="wrapper style2 container special-alt">
          <div className="row half">
              <div className="8u">
                  <header>
                      <h2><b><strong>a little bit about what i do</strong></b></h2></header>
                  <p>I enjoy building webapps using <strong className='TypeScriptBlue'>TypeScript</strong> with frameworks such as <strong className="ReactBlue"> React.JS </strong> or <strong className="VueGreen">Vue.JS</strong> in the frontend, and
